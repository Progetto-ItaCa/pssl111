...
The public entrance to the building is on Mura Anteo Zamboni, gate marked #highlight[2B].
...
#html.elem("div", attrs: (class: "banner"))[
  #html.elem("figure")[
    ...
    #html.elem("figcaption")[
      #html.elem("small")[
        #link(
          "https://www.openstreetmap.org/?mlat=44.496793&mlon=11.356352#map=19/44.496793/11.356352",
        )[View Larger Map]
        #sym.dot.c
        #link("https://maps.app.goo.gl/RQZRDoHsvpsoVGq67")[View in Google Maps]
        #sym.dot.c
...
The quickest way to get from Bologna Airport to the city is to take #link("https://www.marconiexpress.it/en/")[Marconi Express], which will take you to the Bologna Central train station. You could also take a private taxi, which is not usually too expensive, but requires a bit of waiting. Uber Black is the only other ride-sharing service available.

If you're catching a flight from the airport, we recommend getting there early to make it through the security checks, because the airport is quite small and tends to get very busy, especially during peak hours and tourist season.

*Bologna Central Station*

The city center is within a short walking distance from the train station, and well-connected by public transport. You could use #link("https://citymapper.com/")[Citymapper], for example, to plan your journey.
...
The dinner will be at #highlight[#link("https://maps.app.goo.gl/3dqT9cX9EZZdaBUq6")[Buca San Petronio]].
...
- #link("https://maps.app.goo.gl/X3RZGaeimHy1B5VXA")[Centro Natura] - Vegan & vegetarian bistro
